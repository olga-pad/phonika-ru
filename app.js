'use strict';
document.write('<script src="./app-core.js?v=53"><\/script>');
window.addEventListener('DOMContentLoaded',()=>{
  ...
  if(stylePanel&&summary&&!stylePanel.classList.contains('parent-collapsible'))summary.insertAdjacentElement('afterend',stylePanel);
