...
window.addEventListener('DOMContentLoaded',()=>{
  ...
  if(styleSelectEl&&styleMenuEl){
    ...
    styleMenuEl.querySelectorAll('.style-option').forEach(btn=>btn.addEventListener('click',()=>{style=btn.dataset.style||'upper';persist();styleRender();styleMenuEl.hidden=true;}));
  }
